...
$credit_total_amt = $opening_bal + $member_amt + $account_amt + $savings_renewal_amt + $loan_renewal_amt + $pmk_received_amt + $ramnad_received_amt + $mudhuvai_received_amt + $ho_received_amt + $deduction_amt;




$debit_total_amt = $loan_amt + $maturity_amt + $prematurity_amt + $expense_amt + $pmk_remitted_amt + $ramnad_remitted_amt + $mudhuvai_remitted_amt + $ho_remitted_amt;
