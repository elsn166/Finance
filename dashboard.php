...
}.grad3, .dashboard-custom-date-picker .react-datepicker .react-datepicker__header {
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="col-md-6" style="margin-left: 538px;margin-top: -165px;">
         ...
         <h6>- Daily Deposit Account</h6>
         <h6>- Weekly Deposit Account</h6>
         <h6>- Monthly Deposit Account</h6>
         <h6>- Fixed Deposit Account</h6>
        </div>
...
<?php $expense_count_one_total=$expense_count_one+$loan_count_one+ $loan_fwdclose_one+$maturity_count_one+$pre_maturity_count_one?>
      <div class="col-lg-6 col-6">
        <!-- small box -->
        <div class="small-box grad1">
          <div class="inner">

            <h5 class="">Paramakudi <?php echo $expense_count_one_total ; ?></h5>
            <h6>Pending For Expense Approval <?php echo $expense_count_one; ?></h6>
            <h6>Pending For Loan Approval <?php echo $loan_count_one ; ?></h6>
            <h6>Pending Approval For Loan Closing <?php echo $loan_fwdclose_one  ; ?></h6>
            <h6>Pending Approval For Maturity <?php echo $maturity_count_one ; ?></h6>
            <h6>Pending Approval For Pre-Maturity<?php echo $pre_maturity_count_one ; ?></h6>
            </div>
          <a href="dashboard_old.php?b_id=1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
<?php $expense_count_two_total=$expense_count_two+$loan_count_two+ $loan_fwdclose_two+$maturity_count_two+$pre_maturity_count_two?>
      <div class="col-lg-6 col-6">
        <!-- small box -->
        <div class="small-box grad2">
          <div class="inner">
            <h5>Mudukulathur <?php echo $expense_count_two_total ; ?></h5>
            <h6>Pending For Expense Approval <?php echo $expense_count_two; ?></h6>
            <h6>Pending For Loan Approval <?php echo $loan_count_two ; ?></h6>
            <h6>Pending Approval For Loan Closing <?php echo $loan_fwdclose_two  ; ?></h6>
            <h6>Pending Approval For Maturity <?php echo $maturity_count_two ; ?></h6>
            <h6>Pending Approval For Pre-Maturity<?php echo $pre_maturity_count_two ; ?></h6>
        </div>
          <!-- <div class="icon">
            <i class="ion ion-stats-bars"></i>
          </div> -->
          <a href="dashboard_old.php?b_id=2" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      
<?php $expense_count_three_total=$expense_count_three+$loan_count_three+ $loan_fwdclose_three+$maturity_count_three+$pre_maturity_count_three?>
      <div class="col-lg-6 col-6">
        <!-- small box -->
        <div class="small-box grad3">
          <div class="inner">
            <h5>Ramnad <?php echo $expense_count_three_total ; ?></h5>
            <h6>Pending For Expense Approval <?php echo $expense_count_three; ?></h6>
            <h6>Pending For Loan Approval <?php echo $loan_count_three ; ?></h6>
            <h6>Pending Approval For Loan Closing <?php echo $loan_fwdclose_three  ; ?></h6>
            <h6>Pending Approval For Maturity <?php echo $maturity_count_three ; ?></h6>
            <h6>Pending Approval For Pre-Maturity<?php echo $pre_maturity_count_three ; ?></h6>
          ...
          <a href="dashboard_old.php?b_id=3" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
      
<?php $expense_count_four_total=$expense_count_four+$loan_count_four+ $loan_fwdclose_four+$maturity_count_four+$pre_maturity_count_four?>
      <div class="col-lg-6 col-6">
        <!-- small box -->
        <div class="small-box grad4">
          <div class="inner">
            <h5>Pudur <?php echo $expense_count_four_total ; ?></h5>
            <h6>Pending For Expense Approval <?php echo $expense_count_four; ?></h6>
            <h6>Pending For Loan Approval <?php echo $loan_count_four ; ?></h6>
            <h6>Pending Approval For Loan Closing <?php echo $loan_fwdclose_four  ; ?></h6>
            <h6>Pending Approval For Maturity <?php echo $maturity_count_four ; ?></h6>
            <h6>Pending Approval For Pre-Maturity<?php echo $pre_maturity_count_four ; ?></h6>
          </div>
          
          <!-- <div class="icon">
            <i class="ion ion-stats-bars"></i>
          </div> -->
          <a href="dashboard_old.php?b_id=4" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
