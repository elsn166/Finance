...
?>
      <?php
              $branch_list=select_data(BRANCH_MASTER,"where branch_id= $branch_id  ORDER BY branch_id ASC");
...
<h5>Regd.Office:1/163,P.S.S.Nivas Building First Floor, Keelapallivasal Street, Paramakudi - 623707.</h5>
   ...
   <b> Branch Name:   <?php echo $bl['branch_name'];?></b>  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<section class="content">
  ...
  <form method="POST" action="" id="form1" name="form1">
      ...
      <?php if(isset($_GET['branch_id'])) { 
        ...
        $loan_details=select_data(LOAN_MASTER,"where branch_id='".$_GET['branch_id']."' ORDER BY loan_id DESC");?>
