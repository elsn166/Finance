...
if(isset($_POST['update']))
{
 ...
 if(isset($_POST['submit']))
 {
  ...
  { 
      ...
      echo "<script type='text/javascript'>window.location='member_personal.php?customer_id=".$last_id."&success=Details Added Successfully';</script>";
...
<?php } ?>
 ...
 <!-- <div class="form-group row">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="customer_name" class="form-control" id="customer_name" placeholder="Enter Member Name" value="<?php echo $customer_name; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
        ...
        <?php } else{
            ...
            <div class="col-sm-5">
              <input type="text" name="mother_name" class="form-control" id="mother_name" placeholder="Enter Mother's Name" value="<?php echo $mother_name; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="father_name" class="form-control" id="father_name" placeholder="Enter Father's Name" value="<?php echo $father_name; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
            ...
            <div class="col-sm-5">
              <input type="text" name="husband_name" class="form-control" id="husband_name" placeholder="Enter Husband's Name" value="<?php echo $husband_name; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
              <select name="gender_id" class="form-control" id="gender_id" <?php echo $disabled; ?>>
...
<div class="form-group row">
            ...
            <div class="col-sm-5">
              <select name="employee_id" class="form-control" id="employee_id" <?php echo $disabled; ?>>
              <option value="">Select Employee Name</option>
              <?php
              $employee_list=select_data(EMPLOYEE_MASTER," where employee_name != 'admin' AND status != '0' ORDER BY employee_id ASC");
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
              <select name="marital_status_id" class="form-control" id="marital_status_id" <?php echo $disabled; ?>>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="mobile_number" class="form-control" id="mobile_number" placeholder="Enter Mobile Number" value="<?php echo $mobile_number; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="email" class="form-control" id="email" placeholder="Enter Email-ID" value="<?php echo $email; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              <select name="blood_group_id" class="form-control" id="blood_group_id" <?php echo $disabled; ?>>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="dob" class="form-control" id="dob" placeholder="Select Date Of Birth" value="<?php echo $dob; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
            ...
            <div class="col-sm-5">
              <input type="text" name="nationality" class="form-control" id="nationality" placeholder="Enter Nationality" value="<?php echo $nationality; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>

          <div class="form-group row">
            <label for="employee_name" class="col-sm-2 col-form-label">Member Creation Date<span style="color:red">*</span></label>
            <div class="col-sm-5">
              <input type="text" name="mcd" class="form-control" id="mcd" placeholder="Select Date" value="<?php echo $mcd; ?>" <?php echo $disabled; ?>/>
            </div>
          </div>
...
messages: {
  ...
  mcd: {required: 'Please Select Member Creation Date' }
