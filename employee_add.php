...
if(isset($_GET['action']) && $_GET['action']=="edit" )
{
    ...
    $certificate_id_arr = explode(",",$certificate_id);
    ...
    $joindate= $employee_details[0]['date_of_joining'];
    $relieving= $employee_details[0]['date_of_relieving'];
    $upload_files = $employee_details[0]['upload_files'];
    $status_val = $employee_details[0]['status'];
}

// print_r($certificate_id_arr);
...
if(isset($_POST['update']))
{
  ...
  $data['status'] = $status;
  $data['salary'] = $salary;
  $data['date_of_joining'] = $joindate;
  $data['date_of_relieving'] = $relievingdate;
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
            <label for="employee_name" class="col-sm-2 col-form-label">Date of Joining<span style="color:red">*</span></label>
            <div class="col-sm-5">
              <input type="text" name="joindate" class="form-control" id="joindate" placeholder="Select Date Of Joining" value="<?php echo $joindate; ?>" />
            </div>
          </div>
             
          <?php if(isset ($_GET['employee_id'] )!=""){ ; ?>
            <div class="form-group row">
            <label for="employee_name" class="col-sm-2 col-form-label">Date of Relieving<span style="color:red">*</span></label>
            <div class="col-sm-5">
              <input type="text" name="relievingdate" class="form-control" id="relievingdate" placeholder="Select Relieving Date " value="<?php echo $relievingdate; ?>" />
            </div>
          </div>
            <?php } ?>
            <div class="form-group row">
            <label for="employee_name" class="col-sm-2 col-form-label">Salary<span style="color:red">*</span></label>
            <div class="col-sm-5">
              <input type="text" name="salary" class="form-control" id="salary" placeholder="Select Slaray" value="<?php echo $salary; ?>" />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              ...
              {
              ?>
                <option value="<?php echo $cl['type_id'];?>" <?php if(in_array($cl['type_id'],$certificate_id_arr)){ echo 'selected'; } ?>><?php echo $cl['type_name'];?></option>
                <?php  
              }
              ?>
              </select>
