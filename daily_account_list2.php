...
{
  $update_tallyqry="UPDATE ".TALLY_MASTER." set opening_balance='$closing_bal' where date='$selecteddate' and branch_id='$session_branch_id'";
  print_r($update_tallyqry);
  exit;
...
{ ?>
    ...
    <input type="hidden" name="selecteddate" value="<?php echo $_POST['tally_date']; ?>" />
    </div>
    </div>
