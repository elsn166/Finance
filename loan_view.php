    ...
    <div class="card card-outline card-success">
      <div class="card-header">
        <h3 class="card-title">Loan Details</h3>
         ...
         <a class="btn-sm btn-success mx-2 float-right" href="loan_view_print.php?branch_id=<?php echo $branch_id; ?>" target="_blank">Print</a>
  ...
  <form method="POST" action="" id="form1" name="form1">
    ...
    <div class="form-group row">
      ...
      <button type="submit" class="btn-sm btn-success" id="submit">Submit</button>
        ...
        $loan_details=select_data(LOAN_MASTER,"where branch_id='".$_POST['branch_id']."' ORDER BY loan_id DESC");?>
    ...
    <section class="content">
      ...
      <div class="card-header">
        ...
        <!-- <a class="btn-sm btn-success float-right" href="#">Print</a> -->
         <a class="btn-sm btn-success float-right" href="loan_view_print.php?branch_id=<?php echo $session_branch_id; ?>" target="_blank">Print</a>
