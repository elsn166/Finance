...
if(count($get_tally_details )>0)
{
  ...
  //print_r($loantallyamt);
   
  $new_loantally_amt = $loan_amount;
  //print_r($new_loantally_amt);
  
  
  $nloantallyamt = (int)$loantallyamt+(int)$new_loantally_amt;
  
  //print_r($nloantallyamt);
  //exit;
