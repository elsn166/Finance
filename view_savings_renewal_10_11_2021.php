...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        {
       $account_details=select_data(ACCOUNT_MASTER,"ORDER BY account_id ASC");
        }
        else{
          $account_details=select_data(ACCOUNT_MASTER,"where branch_id='".$session_branch_id."' ORDER BY account_id ASC");
        }
        ?>
