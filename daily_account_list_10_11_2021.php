...
$credit_total_amt = $opening_bal + $member_amt + $account_amt + $savings_renewal_amt + $loan_renewal_amt + $pmk_received_amt + $ramnad_received_amt + $mudhuvai_received_amt + $ho_received_amt;
