  ...
  <div class="container-fluid">
    ...
    <div class="card card-outline card-success">
      <div class="card-header">
        <h3 class="card-title">Maturity List</h3>
...
$account_details=select_data(ACCOUNT_MASTER,"where status=2 and maturity_acct=1 and branch_id='".$_POST['branch_id']."' ORDER BY account_id DESC");
?>
