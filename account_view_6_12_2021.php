...
<?php if(isset($_POST['branch_id'])) { ?>
  ...
  <?php
 $account_details=select_data(ACCOUNT_MASTER,"where status!=3 and branch_id='".$_POST['branch_id']."' ORDER BY account_id DESC");
...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        {
        $account_details=select_data(ACCOUNT_MASTER,"where status!=3 ORDER BY account_id DESC");
        }
        else{
        $account_details=select_data(ACCOUNT_MASTER,"where status!=3 and branch_id='".$session_branch_id."' ORDER BY account_id DESC");
        }
        ?>
