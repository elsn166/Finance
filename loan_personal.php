...
//the above part is only functioned by admin
  ...
  { 
    ...
    if($session_role_id == 1)
    {
      echo "<script type='text/javascript'>window.location='loan_view.php?&success=Loan Details Approved Successfully';</script>";
    }
    else{
      echo "<script type='text/javascript'>window.location='loan_view.php?&success=Loan Details Forwarded Successfully';</script>";
...
//the above part is only functioned by admin
  ...
  { 
    ...
    if($session_role_id == 1)
    {
      echo "<script type='text/javascript'>window.location='loan_view.php?&success=Loan Details Closed Successfully';</script>";
    }
    else{
      echo "<script type='text/javascript'>window.location='loan_view.php?&success=Loan Details Forwarded Successfully';</script>";
