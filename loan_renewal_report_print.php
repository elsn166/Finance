...
<div class="form-group row">
    <b>
<label for="from_date" class="col-sm-1 col-form-label">From Date : <?php echo $from_date; ?><span style="color:red"></span></label>
<div class="col-sm-3">
...
<label for="to_date" class="col-sm-1 col-form-label">To Date :<?php echo $to_date; ?> <span style="color:red"></span></label>
<div class="col-sm-3">
