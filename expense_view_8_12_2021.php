...
$expense_details=select_data(EXPENSE_MASTER,"where branch_id='".$_POST['branch_id']."' ORDER BY expense_date DESC"); ?>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php
         ...
         {
        $expense_details=select_data(EXPENSE_MASTER,"ORDER BY expense_id DESC");
         }
         else{
          $expense_details=select_data(EXPENSE_MASTER,"where branch_id='".$session_branch_id."' ORDER BY expense_id DESC");  
         }
        ?>
