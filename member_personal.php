...
<?php } ?>
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
            <select name="occupation_id" class="form-control select2" id="occupation_id"  <?php echo $disabled; ?>>
              <option value="">Select Occupation</option>
              <?php
              // $occupation_list=select_data(TYPE_MASTER," where category='occupation'");
              $occupation_list=select_data(OCCUPATION_MASTER,"order by occupation_id");
              foreach($occupation_list as $ol)
              {
              ?>
                <option value="<?php echo $ol['occupation_id'];?>" <?php if($occupation_id == $ol['occupation_id']){ echo 'selected'; } ?>><?php echo $ol['occupation_name'];?></option>
                <?php  
              }
              ?>
              </select>
          ...
          <?php } ?> -->
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-5">
            <select name="income_id" class="form-control" id="income_id" <?php echo $disabled; ?> >
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-5">
            <select name="proof_of_identity[]" class="form-control select2" id="proof_of_identity" multiple  <?php echo $disabled; ?>>
  ...
  <div class="form-group row">
            ...
            <div class="col-sm-5">
            <select name="proof_of_addr[]" class="form-control select2" id="proof_of_addr" multiple  <?php echo $disabled; ?>>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="aadhar_no" maxlength="12" minlength="12" class="form-control" id="aadhar_no" placeholder="Enter AADHAR No" value="<?php echo $aadhar_no; ?>"  <?php echo $disabled; ?>/>
            </div>
          </div>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input type="text" name="pan_no" maxlength="10" minlength="10" class="form-control" id="pan_no" placeholder="Enter PAN No" value="<?php echo $pan_no; ?>"  <?php echo $disabled; ?>/>
            </div>
          </div>
        </div>
        <!-- /.card-body -->
