          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <div class="card-header">
                <h3 class="card-title">Maturity Report</h3>  
                             <a class="btn-sm btn-success float-right" href="maturity_report_print.php?branch_id=<?php echo $branch_id;?>&from_date=<?php echo $from_date;?>&to_date=<?php echo $to_date;?>"target="_blank">Print</a>
...
//   $branch_id = $_POST['branch_id'];
  ...
  <a href="maturity_report_view_list.php?action=view&account_id=<?php echo $ad['account_id']; ?>"><span class="btn-sm btn-success"><i class="fas fa-eye"></i></span></a> &nbsp;
