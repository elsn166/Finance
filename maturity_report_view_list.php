...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Maturity Report - Savings Renewal List</h1>
          </div>
  ...
  <div class="container-fluid">
    ...
    <div class="card card-outline card-success">
      <div class="card-header">
        <h3 class="card-title">Maturity Report - Savings Renewal List</h3>

  <a class="btn-sm btn-success float-right" href="maturity_report_view_print.php?account_id=<?php echo $ad['account_id']; ?>"target="_blank">Print</a>
