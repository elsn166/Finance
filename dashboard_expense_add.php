...
if(isset($_POST['update']))
{
  ...
  { 
    $bid = $_GET['b_id'];
    echo '<script type="text/javascript">window.location="dashboard_expense_view.php?b_id='.$bid.'&success=Daily Expense Updated Successfully;"</script>';
  }
 ...
 if(isset($_POST['submit']))
 {
    ...
    if($session_role_id == 1)
    {
      ...
      if((int)$expense_type_id != 21 && (int)$expense_type_id != 22 && (int)$expense_type_id != 20 && (int)$expense_type_id != 19 && (int)$expense_type_id != 14 && (int)$expense_type_id != 15 && (int)$expense_type_id != 16 && (int)$expense_type_id != 17)
      {
    ...
    if($insert!=0)
    { 
        echo '<script type="text/javascript">window.location="dashboard_expense_view.php?b_id=<?php echo "'.$GET['b_id'].'"; ?>&success=Daily Expense Added Successfully";</script>';
  ...
  <div class="container-fluid">
    ...
    <div class="card card-outline card-success">
      <div class="card-header">
        ...
        <a class="btn-sm btn-success float-right" href="dashboard_expense_view.php?b_id=<?php echo $_GET['b_id'];?>">Back</a>
