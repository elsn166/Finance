...
// Call Application Level Requirements once a Page Load
...
include("include/functions_pack.php");

$uname=$_POST['uname'];
$pass=$_POST['pwd'];
$retrieve = login($uname,$pass);
if($uname==$retrieve["uname"] and $pass==$retrieve["password"])
{
    $_SESSION['ActiveLoginType'.SESSION_TOKEN]=$retrieve['user_id'];
    $_SESSION['ActiveUsername'.SESSION_TOKEN]=$retrieve['uname'];
...
<title>Society Admin Dashboard Template</title>
...
<div class="wrapper">
 ...
 <form role="form" class="form-horizontal" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="password" placeholder="Password" id="pwd" name="pwd" class="form-control"> <font color="#FF0000"> <?php print $msg; ?> </font>
        </div>
      </div>
      <div class="form-group">
        <div class=" col-sm-10">
          <div class="checkbox checkbox_margin">
            <label class="lable_margin">
              ...
              <input name="s1" class="btn btn-default pull-right" type="submit" value="Sign in"></button>
              </a></div>
        </div>
      </div>
